...
import { FoodTypeKey } from "schema/bodyType.schema";
...
interface AddFoodModalProps {
  ...
  toggleModal: () => void;
  foodKey: string;
  setFoodKey: Dispatch<SetStateAction<string>>;
  foodValues: string[];
...
function AddFoodModal({
  ...
  return (
    <Modal isOpen={isModalOpen} onClose={toggleModal} title="음식 추가하기">
      <Wrapper>
        <CustomInput
          label="카테고리"
          initialValue={foodKey}
          passedHandleChange={(e) => setFoodKey(e as FoodTypeKey)}
        />
        ...
        <CustomButton
          ...
          isDisabled={foodKey === "" || foodValues.length === 0}
          size="lg"
        />
      </Wrapper>
    </Modal>
